    ...
    <div class="blog-section">
        <div class="container">
            <div class="row py-5 m-auto text-center">
                <div class="col">
                    <h2 class='text-primary'>Our Laravel All blogs</h2>
                </div>
            </div>
            <div class="row py-5 bg-light">
                ...
                <div class="col-md-9">
                    <div class="row text-center py-2">
                        <div class="col-md-3">
                            <div class="card" style="width: 12rem;">
                                <img class="card-img-top img-fluid " src="img/lar-1.jpg" alt="Card image cap">
                                <p>30 january 2021</p>
                            </div>
                        </div>
                        <div class="col-md-9">
                    ...
                    <div class="row text-center py-2">
                        <div class="col-md-3">
                            <div class="card" style="width: 12rem;">
                                <img class="card-img-top img-fluid " src="img/lar-2.png" alt="Card image cap">
                                <p>30 january 2021</p>
                            </div>
                        </div>
                        <div class="col-md-9">
                    ...
                    <div class="row text-center py-2">
                        <div class="col-md-3">
                            <div class="card" style="width: 12rem;">
                                <img class="card-img-top img-fluid " src="img/lar-3.png" alt="Card image cap">
                                <p>30 january 2021</p>
                            </div>
                        </div>
                        <div class="col-md-9">
